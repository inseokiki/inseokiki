/* ================================================================
 *  ldpc_tables.c
 *  TS 38.212 Table 5.3.2-1/5.3.2-2/5.3.2-3 data -- see ldpc_tables.h for
 *  provenance and self-check notes. Pure data, no logic.
 *
 *  Author : Inseok Kang
 * ================================================================ */
#include "ldpc_tables.h"

const BGEntry BG1_TABLE[316] = {
...
const int ZC_SETS[ZC_NUM_SETS][8] = {
...
const int ZC_SET_LEN[ZC_NUM_SETS] = {8, 8, 7, 6, 6, 6, 5, 5};
